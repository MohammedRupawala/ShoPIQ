...
import { productType,baseQuery, searchQuery } from "../types/type.js";
...
export const getAdminProducts = TryCatch(async (req,res,next)=>{
    ...
    if(myCache.has("adminProducts")){
        products = myCache.get(JSON.parse("adminProducts") as string)
    }
    else {
...
export const newProduct = TryCatch(async(req:Request<{},{},productType>,res:Response,next:NextFunction)=>{
